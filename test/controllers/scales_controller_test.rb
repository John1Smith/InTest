...
class ScalesControllerTest < ActionController::TestCase
  ...
  test "should create scale" do
    assert_difference('Scale.count') do
      post :create, scale: { for_user: @scale.for_user, name: @scale.name, questions: @scale.questions, result: @scale.result, test_id: @scale.test_id }
    end
  ...
  test "should update scale" do
    patch :update, id: @scale, scale: { for_user: @scale.for_user, name: @scale.name, questions: @scale.questions, result: @scale.result, test_id: @scale.test_id }
    assert_redirected_to scale_path(assigns(:scale))
  end
